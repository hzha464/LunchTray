...
public class FragmentSideMenuBindingImpl extends FragmentSideMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.SideMenueFragment == variableId) {
            setSideMenueFragment((com.example.lunchtray.ui.order.SideMenuFragment) variable);
        }
    ...
    public void setSideMenueFragment(@Nullable com.example.lunchtray.ui.order.SideMenuFragment SideMenueFragment) {
        this.mSideMenueFragment = SideMenueFragment;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
        notifyPropertyChanged(BR.SideMenueFragment);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.ui.order.SideMenuFragment sideMenueFragment = mSideMenueFragment;
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            ...
            case 5: {
                ...
                // SideMenueFragment
                com.example.lunchtray.ui.order.SideMenuFragment sideMenueFragment = mSideMenueFragment;
                // SideMenueFragment != null
                boolean sideMenueFragmentJavaLangObjectNull = false;



                sideMenueFragmentJavaLangObjectNull = (sideMenueFragment) != (null);
                if (sideMenueFragmentJavaLangObjectNull) {


                    sideMenueFragment.cancelOrder();
                }
                break;
            }
            case 2: {
            ...
            case 6: {
                ...
                if (sideMenueFragmentJavaLangObjectNull) {
                    ...
                    sideMenueFragment.goToNextScreen();
                }
                break;
            }
            case 1: {
