...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        java.lang.String accompanimentPriceAndroidStringPriceViewModelAccompanimentPrice = null;
        java.lang.String sidePriceAndroidStringPriceViewModelSidePrice = null;
        ...
        java.lang.String entreePriceAndroidStringPriceViewModelEntreePrice = null;
        ...
        if ((dirtyFlags & 0x1bfL) != 0) {
            ...
            if ((dirtyFlags & 0x181L) != 0) {
                    ...
                    accompanimentPriceAndroidStringPriceViewModelAccompanimentPrice = accompanimentPrice.getResources().getString(R.string.price, viewModelAccompanimentPrice);
            }
            ...
            if ((dirtyFlags & 0x184L) != 0) {
                    ...
                    // read @android:string/price
                    entreePriceAndroidStringPriceViewModelEntreePrice = entreePrice.getResources().getString(R.string.price, viewModelEntreePrice);
            }
            ...
            if ((dirtyFlags & 0x190L) != 0) {
                    ...
                    // read @android:string/price
                    sidePriceAndroidStringPriceViewModelSidePrice = sidePrice.getResources().getString(R.string.price, viewModelSidePrice);
            }
        ...
        if ((dirtyFlags & 0x181L) != 0) {
            ...
            this.accompanimentPrice.setText(accompanimentPriceAndroidStringPriceViewModelAccompanimentPrice);
        ...
        if ((dirtyFlags & 0x184L) != 0) {
            ...
            this.entreePrice.setText(entreePriceAndroidStringPriceViewModelEntreePrice);
            this.entreeSelection.setText(viewModelEntreeName);
        }
        if ((dirtyFlags & 0x190L) != 0) {
            // api target 1

            this.sidePrice.setText(sidePriceAndroidStringPriceViewModelSidePrice);
